...
class LaunchhistorySpider(scrapy.Spider):
    ...
    def parse(self, response):
        launches = {
            ...
            'ilsDate' : response.xpath(".//div[contains(@class, 'company-international-launch-services-ils')]/div[@class='launch_info_left_container large-2 medium-2 small-3 columns']/div[@data-sortdate]/@title").extract(),
